...
import br.unipar.spaceinvaders.sprite.Alien;
import br.unipar.spaceinvaders.sprite.Player;
import br.unipar.spaceinvaders.sprite.Shot;
        ...
        while(it.hasNext()){
            ...
            if(alien.isVisible()){
                ...
                if(y > Commons.GROUND - Commons.ALIEN_HEIGHT){
                    inGame = false;
                    message = "VOCÊ FOI INVADIDO - LOSER";
